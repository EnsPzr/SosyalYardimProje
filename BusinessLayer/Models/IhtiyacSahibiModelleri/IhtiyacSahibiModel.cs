...
namespace BusinessLayer.Models.IhtiyacSahibiModelleri
{
    public class IhtiyacSahibiModel
    {
        ...
        [MaxLength(30,ErrorMessage = "İhtiyac sahibi adı en fazla {1} karakter olabilir."),MinLength(6,ErrorMessage = "İhtiyac sahibi adı en az {1} karakter olabilir.")]
        ...
        [MaxLength(30, ErrorMessage = "İhtiyac sahibi Soyadı en fazla {1} karakter olabilir."), MinLength(6, ErrorMessage = "İhtiyac sahibi Soyadı en az {1} karakter olabilir.")]
